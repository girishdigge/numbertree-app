  ...
  return (
    <div className=''>
      ...
      <div className='relative '>
        <Image
          src={`/projects/mumbaiDelhiExpressway1.jpg`}
          width={2046}
          height={768}
          ...
          <div className='ml-10'>
            ...
            <div className='border-l-4 md:w-1/2 border-num-orange'>
              ...
              <h1 className='font-bold md:text-5xl text-2xl md:mb-2 border-num-orange ml-2 flex animate-fadeIn animate-fadeInRight'>
                (Package VII) Mojrapur (Azamgarh) to Bijaura Ghazipur
              </h1>
            </div>
      ...
      <div className='flex md:flex-row flex-col'>
        <div className='md:flex md:w-1/5   pl-4 flex-col'>
          ...
          <div className='flex flex-col gap-y-2  tracking-widest'>
            ...
            <h3>
              Development of Purvanchal Expressway (Package VII) Mojrapur
              (Azamgarh) to Bijaura Ghazipur
            </h3>
        ...
        <div className='md:w-3/5 flex flex-col items-center text-justify'>
          ...
          <div className='flex flex-col items-center '>
            ...
            <br /> */}
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Package VII of the Purvanchal Expressway is the stretch of green-field alignment between Mojrapur in the Azamgarh district and Bijaura in the Ghazipur district. The Purvanchal expressway connected with existing Agra-Lucknow Expressway is expected to become a vast Industrial Corridor connecting Eastern boundary to Western boundary of the state which will result into overall development of the state.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`The Purvanchal Expressway (Package VII) is a greenfield expressway that connects several central districts of Uttar Pradesh, including Lucknow, Barabanki, Amethi, Sultanpur, Ayodhya, Ambedkar Nagar, Azamgarh, Mau, and Ghazipur. The expressway will help boost social and economic development in these districts, and will also connect these places with cities like Delhi and Patna.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`With the Construction of Purvanchal Expressway, accelerated convenient mode of transportation is available between the eastern boundary of the state and the national capital via state capital through other similar Expressways in the State viz. 'Agra to Lucknow Expressway'  and 'Yamuna Expressway'`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Being an Access Controlled Expressway, it would provide benefits like fuel-saving, time saving and Control in Pollution level, along with reduction in accidents. The areas covered by this expressway would be benefited in a social & economical way. Agriculture, commerce, tourism, and other industrial development will also get a fillip.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Industrial Training Institutes, Educational Institutes, Medical Institutes, New Townships and other various Commercial set ups are to be developed  especially near the Expressway areas resulting  into more opportunities for employment in the region. The overall social/economic development in the state will get a boost.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`The expressway is the catalyst for the development of the region and State.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Numbertree provided concurrent techno commercial audit services to this project.`}
            </p>{' '}
            <br />
