...
const Page = () => {
  return (
    <div className=''>
      <div className='flex flex-row mt-2 mb-2 ml-12'>
        ...
        <RxSlash color='gray' className='mt-1' />
        <p className='font-bold text-num-indigo'>Al Maktoum</p>
      </div>
      ...
      <div className='flex md:flex-row flex-col'>
        <div className='md:flex md:w-1/5   pl-4 flex-col'>
          ...
          <div className='flex flex-col gap-y-2  tracking-widest'>
            ...
            <h3>Al Maktoum Hospital redevelopment </h3>
        ...
        <div className='md:w-3/5 flex flex-col items-center text-justify'>
          ...
          <div className='flex flex-col items-center '>
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`NumberTree had the privilege to work on the challenging Deira Al-Maktoum hospital renovation project in Dubai as Quantity Surveyors. Our team of senior engineers, quantity surveyors , and chartered accountants worked collaboratively for over 4 months to contribute constructively to this assignment. We provided cost consultancy sand cost overrun analysis for the project.
 ...
 `}
            ...
            <br /> */}
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`The scope of our work included bill verification and BOQ preparation. At NumberTree, we take immense pride in our technical capabilities, which have been honed over close to two decades of delivering value to our clients. This project showcased our experience in handling complex assignments, allowing us to leverage our expertise.
We remain committed to delivering excellence in our services, to add value to our clients & drive a positive impact
`}
            </p>{' '}
            <br />
          </div>
