  ...
  return (
    <div className=''>
      <div className='flex flex-row mt-2 mb-2 ml-12'>
        ...
        <RxSlash color='gray' className='mt-1' />
        <p className='font-bold text-num-indigo'>Leh Airport</p>
      </div>
      <div className='relative '>
        <Image
          src={`/projects/leh.jpg`}
          width={2046}
          height={768}
          alt='red sea'
      ...
      <div className='flex md:flex-row flex-col'>
        <div className='md:flex md:w-1/5   pl-4 flex-col'>
          ...
          <div className='flex flex-col gap-y-2  tracking-widest'>
            ...
            <h3>
              LEH airport Construction of terminal building & associated work
            </h3>
        ...
        <div className='md:w-3/5 flex flex-col items-center text-justify'>
          ...
          <div className='flex flex-col items-center '>
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              The Kushok Bakula Rimpochee airport at Leh, situated at 3,256 m
              (10,682 ft) above mean sea level, is one of the highest altitude
              airport in India.
            </p>{' '}
            <br />
            ...
            <br /> */}
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`The completion work for the new terminal building at the airport is underway in full swing. It is distinguished as India’s first carbon neutral airport. Designed to reflect the ancient Buddhist philosophy, the terminal design also preserves the natural set up of the landscape. The estimated cost of the project is 480cr and is expected to boost further development in the state.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Large & complex projects like this, requires specialized approach to keep the project under control from financial standpoint. Our expert team, helps to effectively meet project goals while reducing risks and costs.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Numbertree served as cost control techno-commercial auditor for the construction of terminal building and associated work at this airport`}
            </p>{' '}
          </div>
