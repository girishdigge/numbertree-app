  ...
  return (
    <div className=''>
      <div className='flex flex-row mt-2 mb-2 ml-12'>
        ...
        <RxSlash color='gray' className='mt-1' />
        <p className='font-bold text-num-indigo'>Guwahati Airport</p>
      </div>
      <div className='relative '>
        <Image
          src={`/projects/GuwahatiAirport.jpg`}
          width={2046}
          height={768}
          alt='guwahati'
        ...
        <div className='absolute inset-0 flex flex-col md:justify-center bg-opacity-50 bg-black text-white'>
          <div className='ml-10'>
            ...
            <div className='border-l-4 md:w-1/2 border-num-orange'>
              ...
              <h1 className='font-bold md:text-3xl text-2xl md:mb-2 border-num-orange ml-2 flex animate-fadeIn animate-fadeInRight'>
                Guwahati,Assam
              </h1>
            </div>
      ...
      <div className='flex md:flex-row flex-col'>
        <div className='md:flex md:w-1/5   pl-4 flex-col'>
          ...
          <div className='flex flex-col gap-y-2  tracking-widest'>
            ...
            <h3>
              Guwahati Airport Construction of new integrated terminal building
            </h3>
        ...
        <div className='md:w-3/5 flex flex-col items-center text-justify'>
          ...
          <div className='flex flex-col items-center '>
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              The Airports Authority of India (AAI) commissioned a new
              integrated terminal building at Lok Priya Gopinath Bordoloi
              International Airport in Guwahati, Assam, to meet future demand
              and traffic.
            </p>{' '}
            <br />
            ...
            <br /> */}
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`The new terminal is expected to be commissioned in July 2024, and will cost around ₹1,232 crore (US$150 million). The terminal is located on the northern side of the airport, and is expected to double the airport's capacity. `}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`The addition of the new terminal is expected to significantly enhance the airport's functionality and aesthetics, reflecting the rich cultural tapestry of Assam through its association with the Foxtail Orchid. This strategic move is anticipated to further connect Guwahati with more domestic and international destinations, fostering greater connectivity and economic growth in the region. `}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`The new terminal includes an Environmental Management Cell (EMC) to oversee the implementation of mitigation measures during construction and operation.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Numbertree served as techno-commercial auditors for the project as mandated by the developers . `}
            </p>{' '}
            <br />
          </div>
          ...
          <div className='flex gap-x-2 tracking-widest mb-10'>
            ...
            <h2 className='border border-num-orange text-sm  p-1'>Guwahati</h2>
            <h2 className='border border-num-orange text-sm  p-1'>Assam</h2>
          </div>
        </div>
