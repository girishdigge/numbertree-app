    ...
    <div className=''>
      <div className='flex flex-row mt-2 mb-2 ml-12'>
        ...
        <p className='font-bold text-num-indigo'>
          Steel authority of India (SAIL) – New Plate Mill
        </p>
      </div>
      <div className='relative '>
        <Image
          src={`/projects/SAIL.jpg`}
          width={2046}
          height={768}
      ...
      <div className='flex md:flex-row flex-col'>
        <div className='md:flex md:w-1/5   pl-4 flex-col'>
          ...
          <div className='flex flex-col gap-y-2  tracking-widest'>
            ...
            <h3>Steel authority of India (SAIL) – New Plate Mill</h3>
            ...
            <h3>drawing based quantity verification </h3>
          </div>
        </div>
        <div className='md:w-3/5 flex flex-col items-center text-justify'>
          ...
          <div className='flex flex-col items-center '>
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`SAIL installed a 3 million tonnes per annum (MTPA) hot strip mill
              at the Rourkela Steel Plant in 2018. The new mill, which is 4.3
              meters wide, has a capacity of 0.9 MTPA. It's one of the widest in
              the country and is designed to meet the customized plate market.
              The mill can produce a wide range of plates with close tolerances
              to meet international standards, as well as heavy and wide plates
              for the rising ship building and boiler sectors.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`The new 4.3 metre wide Plate Mill has been installed having initial capacity of 1.0 MT which can be augmented to a capacity of 1.8 MT (1.674 MT saleable). The Plate Mill equipped with state-of-art technology produces wide range of plates with close tolerances to meet stringent international standards. For operation with a lean manpower and to avoid loss of material identity throughout the production process, the Plate Mill is equipped with online ultrasonic testing facility and advanced control systems and material tracking facilities.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Numbertree served as techno commercial audit and  drawing based quantity Verification for the project`}
            </p>{' '}
            <br />
            <div className='flex mt-10  gap-x-2 tracking-widest mb-10'>
              ...
              <h2 className='border border-num-orange text-sm  p-1'>orissa</h2>
            </div>
          </div>
        </div>
