  ...
  return (
    <div className=''>
      <div className='flex flex-row mt-2 mb-2 ml-12'>
        ...
        <RxSlash color='gray' className='mt-1' />
        <p className='font-bold text-num-indigo'>State sports Academy</p>
      </div>
      <div className='relative '>
        <Image
          src={`/projects/sports-academy-bihar.jpg`}
          width={2046}
          height={768}
          alt='maruti suzuki'
      ...
      <div className='flex md:flex-row flex-col'>
        <div className='md:flex md:w-1/5   pl-4 flex-col'>
          ...
          <div className='flex flex-col gap-y-2  tracking-widest'>
            ...
            <h3>
              Construction of State Sports Academy cum International Standard
              Modern Cricket Stadium at Rajgir, Nalanda ,Bihar{' '}
            </h3>
