    ...
    <div className=''>
      <div className='flex flex-row mt-2 mb-2 ml-12'>
        ...
        <p className='font-bold text-num-indigo'>
          All India Institute of Management Sciences, Jhajjar
        </p>
      </div>
      <div className='relative '>
        <Image
          src={`/projects/aiimsJhajjar.jpg`}
          width={2046}
          height={768}
          ...
          <div className='ml-10'>
            ...
            <div className='border-l-4 md:w-1/2 border-num-orange'>
              <h1 className='font-bold md:text-7xl text-2xl md:mb-2 border-num-orange ml-2 flex animate-fadeIn animate-fadeInRight'>
                All India Institute of Management Sciences
              </h1>
        ...
        <div className='md:w-3/5 flex flex-col items-center text-justify'>
          ...
          <div className='flex flex-col items-center '>
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              India’s healthcare infrastructure is growing at a rapid pace and
              it is expected to reach even greater heights in the years to come.
              Rising income levels, greater health awareness, increased
              precedence of lifestyle diseases, improved access to insurance and
              various government initiatives would be the key contributors to
              this growth. The Government of India aims to develop India as a
              global healthcare hub and has extended budgetary support under the
              National Health Mission to encourage development of medical
