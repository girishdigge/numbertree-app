  ...
  return (
    <div className=''>
      ...
      <div className='relative '>
        <Image
          src={`/projects/KalyanSinghCancerInstitute.jpeg`}
          width={2046}
          height={768}
      ...
      <div className='flex md:flex-row flex-col'>
        <div className='md:flex md:w-1/5   pl-4 flex-col'>
          ...
          <div className='flex flex-col gap-y-2  tracking-widest'>
            ...
            <h3>Kalyan Singh Cancer Institute</h3>
            ...
            <h3>Forensic Audit of Contractor </h3>
          </div>
        </div>
        <div className='md:w-3/5 flex flex-col items-center text-justify'>
          ...
          <div className='flex flex-col items-center '>
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              ...
              public as well as private players. The public and private
              healthcare systems have together contributed to making India one
              of the leading destinations for high-end diagnostic services with
              tremendous capital investment for advanced diagnostic facilities,
              thus catering to a greater proportion of population. The Govt. of
              India, through its various initiatives, is planning to further
              enhance healthcare services by increasing public health spending
              as a percentage of the country’s GDP.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Kalyan Singh Super Specialty Cancer institute was envisaged by Govt. of Uttar Pradesh to provide comprehensive, under one roof facility for cancer management and undertaking cancer related research work and education.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`This state-of-the-art hospital complex is a 1,250-bed facility that includes OPD Block, OT Block, Radiology Block, Radiation Oncology Block, Administration Block, IPD Block, Kitchen, Ancillary, Entrance Square, Service Corridor and other amenities. The hospital complex has been commissioned in phases since 2020 as per the client requirements. The hospital complex is set to become the largest dedicated cancer institute in India with an advanced national level referral and treatment facility and as a national level institute for research in oncology.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Numbertree was commissioned by the contractor to conduct a comprehensive techno-commercial audit of the project. Throughout the project's duration, Numbertree also performed a forensic audit of the contractor's operations, uncovering discrepancies and providing recommendations to enhance standard operating procedures (SOPs) and controls for future projects.`}
            </p>{' '}
            <br />
            <div className='flex mt-10  gap-x-2 tracking-widest mb-10'>
              ...
              <h2 className='border border-num-orange text-sm  p-1'>Lucknow</h2>
            </div>
          </div>
        </div>
