    ...
    <div className=''>
      <div className='flex flex-row mt-2 mb-2 ml-12'>
        ...
        <p className='font-bold text-num-indigo'>
          Construction of ship building workshop at Goa Shipyard
        </p>
      </div>
          ...
          <div className='ml-10'>
            ...
            <div className='border-l-4 md:w-1/2 border-num-orange'>
              <h1 className='font-bold md:text-7xl text-2xl md:mb-2 border-num-orange ml-2 flex animate-fadeIn animate-fadeInRight'>
                Construction of ship building workshop
              </h1>
      ...
      <div className='flex md:flex-row flex-col'>
        <div className='md:flex md:w-1/5   pl-4 flex-col'>
          ...
          <div className='flex flex-col gap-y-2  tracking-widest'>
            ...
            <h3>Construction of ship building workshop at Goa Shipyard</h3>
            ...
            <Link href={`/sectors/ports`} className='hover:underline'>
        ...
        <div className='md:w-3/5 flex flex-col items-center text-justify'>
          ...
          <div className='flex flex-col items-center '>
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              In keeping pace with today’s dynamic times, Goa Shipyard Ltd.
              launched upon a massive modernization programme aimed at creating
              new facilities and infrastructure even as existing facilities are
              augmented, to undertake the anticipated work load of ship
              construction in the years to come. The modernisation plan is a
              result of the vision to have a contemporary Shipyard. The
              Modernisation Project will give GSL the ability to build vessels
              to customer’s requirements in shorter time frames than at present.
              Once fully complete, it will result in substantial augmentation of
              the Shipyard’s capacity to fabricate steel, aluminium and GRP hull
              vessels to nearly three times its present capacity, whilst also
              leading to a quantum increase in the ship repair segment.
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Our client was entrusted with the construction of ship building workshops and associated facilities of Goa Ship Yard.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Numbertree served as techno-commercial auditor for the project `}
            </p>{' '}
            <br />
            <div className='flex mt-10  gap-x-2 tracking-widest mb-10'>
              ...
              <h2 className='border border-num-orange text-sm  p-1'>Goa</h2>
            </div>
          </div>
        </div>
