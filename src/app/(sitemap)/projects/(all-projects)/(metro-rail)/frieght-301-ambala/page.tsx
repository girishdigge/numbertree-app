    ...
    <div className=''>
      <div className='flex flex-row mt-2 mb-2 ml-12'>
        ...
        <p className='font-bold text-num-indigo'>
          Dedicated Freight Corridor Lot 301 Sahnewal-Pilakhwa
        </p>
      </div>
      <div className='relative '>
        <Image
          src={`/projects/EasternDedicateFreightCorridor301.jpg`}
          width={2046}
          height={768}
          alt='maruti suzuki'
      ...
      <div className='flex md:flex-row flex-col'>
        <div className='md:flex md:w-1/5   pl-4 flex-col'>
          ...
          <div className='flex flex-col gap-y-2  tracking-widest'>
            ...
            <h3>Dedicated Freight Corridor Lot 301 Sahnewal-Pilakhwa </h3>
        ...
        <div className='md:w-3/5 flex flex-col items-center text-justify'>
          ...
          <div className='flex flex-col items-center '>
            ...
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex'>
              {`Numbertree was engaged as auditors, cost overrun investigation audit & bill verification and contract administration for 2 packages of Eastern Dedicated Freight Corridor.
Our services cater to entire landscape of Infrastructure and to every stage of infrastructure development.
`}
            </p>{' '}
            <br />
          ...
          <div className='flex  mt-2 gap-x-2 tracking-widest mb-10'>
            ...
            <h2 className='border border-num-orange text-sm  p-1'>Ambala</h2>
