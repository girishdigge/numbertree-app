  ...
  return (
    <div className=''>
      ...
      <div className='relative '>
        <Image
          src={`/projects/MumbaiMetroThaneBhiwandiKalyan.jpg`}
          width={2046}
          height={768}
      ...
      <div className='flex md:flex-row flex-col'>
        <div className='md:flex md:w-1/5   pl-4 flex-col'>
          ...
          <div className='flex flex-col gap-y-2  tracking-widest'>
            ...
            <h3>Line 5 of Mumbai Metro Project, Thane -Bhiwandi – Kalyan</h3>
        ...
        <div className='md:w-3/5 flex flex-col items-center text-justify'>
          ...
          <div className='flex flex-col items-center '>
            ...
            <br /> */}
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex '>
              {`Numbertree worked on Mumbai Metro  - Thane – Bhiwandi  - Kalyan route . As a consulting engineering and audit services firm we provided technical audit of the project. We also undertook quality and safety audit of the project. Deployed at the site , our engineers and commercial team , worked collaboratively to audit quality controls and safety controls for the clients’ on site team. It entailed a detailed study of their existing quality & safety processes, oversee the application of those controls onsite, highlight lacunae as well as suggest additional safeguarding measures to further fortify this part of their process.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex '>
              {`This enabled the client to have better control on the project as well mitigated risks by flagging out the risk area. Overall improving the project outcome .`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex '>
              {`Our expertise in the sector enables our clients to not just overcome the challenges of the project but will also help them realize their objectives with greater success.
...
`}
            ...
            <div className='flex mb-2  gap-x-2 tracking-widest'>
              ...
              <h2 className='border border-num-orange text-sm  p-1'> Mumbai</h2>
              <h2 className='border border-num-orange text-sm  p-1'>
                Maharashtra
              </h2>
            </div>
