    ...
    <div className=''>
      <div className='flex flex-row mt-2 mb-2 ml-12'>
        ...
        <p className='font-bold text-num-indigo'>
          Elevated & Underground Pune Metro Project (Corridor 1 & 2)
        </p>
      </div>
      <div className='relative '>
        <Image
          src={`/projects/PuneMetro.jpg`}
          width={2046}
          height={768}
          alt='PuneMetro'
          ...
          <div className='ml-10'>
            ...
            <div className='border-l-4 md:w-1/2 border-num-orange'>
              ...
              <h1 className='font-bold md:text-5xl text-2xl md:mb-2 border-num-orange ml-2 flex animate-fadeIn animate-fadeInRight'>
                Elevated & Underground(Corridor 1 & 2)
              </h1>
            </div>
      ...
      <div className='flex md:flex-row flex-col'>
        <div className='md:flex md:w-1/5   pl-4 flex-col'>
          ...
          <div className='flex flex-col gap-y-2  tracking-widest'>
            ...
            <h3>Elevated & Underground Pune Metro Project (Corridor 1 & 2)</h3>
        ...
        <div className='md:w-3/5 flex flex-col items-center text-justify'>
          ...
          <div className='flex flex-col items-center '>
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex '>
              The growing urbanization of Indian cities, has necessitated the
              need for cost effective mass transit options. Metro rail system
              has emerged as the most viable and cost-effective option for urban
              rapid mass transit in India as well as many cities across the
              world.
            </p>{' '}
            <br />
            ...
            <br /> */}
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex '>
              {`India’s upcoming cities like Pune has witnessed a significant rise in its population as well.However, the city lacked an efficient transportation infrastructure. The inception of the Pune Metro project thus became imperative.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex '>
              {`The primary goal of the Pune Metro is to alleviate issues such as traffic congestion, long travel times, and high travel expenses. Post completion of first phase, the Pune metro has had several extensions. The corridor 1 and corridor 2 is one of the most crucial one.`}
            </p>
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex '>
              {
                'The  purple line connects PCMC to Swargate.This new route spans a total length of approximately 16.589 KMs and features a combination of elevated and underground sections for commuter convenience. The transportation route boasts a total of 14 stations for commuters to access. The new elevated Aqua Line connects Vanaz to Ramadi. This Aqua Line extends over a total distance of approximately 14.665 KMs.The Aqua Line consists of a total of 16 stations strategically placed to cater to the needs of commuters. '
              }
            </p>
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex '>
              {`The Purple line (PCMC to Civil Court) and the Aqualine (Vanaz to Ruby Hall Clinic) is all set to ease commute further. `}
            </p>
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex '>
              {` Numbertree worked on both these elevated & underground sections of Pune Metro (corridor 1 & 2).As a consulting engineering and audit services firm we provided technical audit of the project. We also undertook quality and safety audit of the project. `}
            </p>
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex '>
              {` Our team worked on two sites of Pune Metro – corridor 1 which started frpm PCMC uptill Swargate  & Corridor 2 which started from Vanaz to  Ramavadi.`}
            </p>
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex '>
              {`Deployed at the site , our engineers and commercial team , worked collaboratively to audit quality controls and safety controls for the clients on site team. It entailed a detailed study of their existing quality & safety processes, oversee the application of those controls onsite, highlight lacunae as well as suggest additional safeguarding measures to further fortify this part of their process. This enabled the client to have better control on the project as well mitigated risks by flagging out the risk area. Overall improving the project outcome . `}
            </p>
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex '>
              {` Our expertise in the sector enables our clients to not just overcome the challenges of the project but is also helpful for them to realize their objectives with greater success.`}
            </p>
            <br />
            ...
            <div className='flex mb-2  gap-x-2 tracking-widest'>
              <h2 className='border border-num-orange text-sm  p-1'>
                {' '}
                Latest Projects
              </h2>
              <h2 className='border border-num-orange text-sm  p-1'> Pune</h2>
              <h2 className='border border-num-orange text-sm  p-1'>
                Maharashtra
              </h2>
            </div>
