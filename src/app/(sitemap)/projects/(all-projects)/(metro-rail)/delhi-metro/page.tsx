  ...
  return (
    <div className=''>
      <div className='flex flex-row mt-2 mb-2 ml-12'>
        ...
        <RxSlash color='gray' className='mt-1' />
        <p className='font-bold text-num-indigo'>Delhi Metro</p>
      </div>
      <div className='relative '>
        <Image
          src={`/projects/Delhi-Metro.jpg`}
          width={2046}
          height={768}
          alt='maruti suzuki'
          ...
          <div className='ml-10'>
            ...
            <div className='border-l-4 md:w-1/2 border-num-orange'>
              ...
              <h1 className='font-bold md:text-5xl text-2xl md:mb-2 border-num-orange ml-2 flex animate-fadeIn animate-fadeInRight'>
                Construction of 8 elevated Metro stations
              </h1>
            </div>
      ...
      <div className='flex md:flex-row flex-col'>
        <div className='md:flex md:w-1/5   pl-4 flex-col'>
          ...
          <div className='flex flex-col gap-y-2  tracking-widest'>
            ...
            <h3>Construction of 8 elevated Metro stations</h3>
        ...
        <div className='md:w-3/5 flex flex-col items-center text-justify'>
          ...
          <div className='flex flex-col items-center '>
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`The growing urbanization of Indian cities, has necessitated the need for cost effective mass transit options. Metro rail system has emerged as the most viable and cost-effective option for urban rapid mass transit in India as well as many cities across the world. `}
            </p>{' '}
            <br />
            {/* <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'></p>{' '}
            <br /> */}
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Numbertree worked on the project on behalf of the main contractor in the construction of 8 elevated Metro stations in Delhi Metro . The scope of the project as detailed by the contractor was construction of eight elevated stations and a 9,035 meter long elevated metro track for the Delhi Metro. `}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`The project included the design and construction of the elevated viaduct, including the entry exit line, ramp to depot, and eight elevated stations. The stations were , Mayur Vihar-I, Mayur Vihar Pkt-I, Trilokpuri, Vinod Nagar East, Vinod Nagar IP Extension, Anand Vihar, and Karkarduma. The project also included architectural finishing, water supply, sanitary installation, and drainage works for the contractor . `}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`As a consulting engineering and audit services firm we provided cost over run investigative audit .Our expertise in the sector enables our clients to not just overcome the challenges of the project but will also help them realize their objectives with greater success.`}
            </p>{' '}
            <br />
          </div>
