  ...
  return (
    <div className=''>
      <div className='flex flex-row mt-2 mb-2 ml-12'>
        ...
        <RxSlash color='gray' className='mt-1' />
        <p className='font-bold text-num-indigo'>Multimodal Transport System</p>
      </div>
      <div className='relative '>
        <Image
          src={`/projects/HyderabadMetro.jpg`}
          width={2046}
          height={768}
          alt='maruti suzuki'
      ...
      <div className='flex md:flex-row flex-col'>
        <div className='md:flex md:w-1/5   pl-4 flex-col'>
          ...
          <div className='flex flex-col gap-y-2  tracking-widest'>
            ...
            <h3>Multimodal Transport System Hyderabad,Telangana</h3>
        ...
        <div className='md:w-3/5 flex flex-col items-center text-justify'>
          ...
          <div className='flex flex-col items-center '>
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex '>
              {`The Hyderabad Multi-Modal Transport System, often referred to as MMTS, is an extensive commuter rail network located in Hyderabad, India. This system, spanning a length of 90 kilometres (56 miles), was established through a collaborative effort between the Government of Telangana  and the South Central Railway, with operational responsibilities lying under the latter.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex'>
              {`The primary objective of the MMTS is to provide an integrated transportation solution for the city of Hyderabad and its surrounding suburban regions. The network links key locations including Hyderabad, Secunderabad, Falaknuma, Lingampally, Medchal, and Umdanagar, offering a total of 133 MMTS services. These services contribute to efficient and convenient connectivity, benefiting both the city residents and those residing in the adjoining suburban areas.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex'>
              {`Numbertree worked as techno-commercial auditor for three packages of the  project.`}
            </p>{' '}
            <br />
          </div>
          ...
          <div className='flex  mt-2 gap-x-2 tracking-widest mb-10'>
            ...
            <h2 className='border border-num-orange text-sm  p-1'>Hyderabad</h2>
            <h2 className='border border-num-orange text-sm  p-1'>Telangana</h2>
          </div>
        </div>
