  ...
  return (
    <div className=''>
      <div className='flex flex-row mt-2 mb-2 ml-12'>
        ...
        <RxSlash color='gray' className='mt-1' />
        <p className='font-bold text-num-indigo'>Petrapole Land Port</p>
      </div>
      <div className='relative '>
        <Image
          src={`/projects/PetrapoleLandPort.jpg`}
          width={2046}
          height={768}
          alt='new parliment'
        ...
        <div className='md:w-3/5 flex flex-col items-center text-justify'>
          <div className='flex flex-col items-center '>
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`The largest land Port in South Asia, Land port Petrapole is located along the international border between India and Bangladesh, at a distance of about 80 kms from the city of Kolkata.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Petrapole (India)-Benapole (Bangladesh) is an important land border crossing for India-Bangladesh both in terms of trade and passenger movement. Nearly 30 percent of land-based trade between India and Bangladesh takes place through Land Port Petrapole`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Since its operationalization in February 2016, the Land Port has been witnessing an increasing number of passenger movement with an average of 22 lakh people crossing the border post on either side each year.`}
            </p>{' '}
            <br />
            <p className='  md:w-3/4 w-11/12 md:text-lg text-xs flex mb-4'>
              {`Numbertree was appointed for techno-commercial auditors for the project.`}
            </p>{' '}
            <br />
          </div>
          ...
          <div className='flex  mt-2 gap-x-2 tracking-widest mb-10'>
            ...
            <h2 className='border border-num-orange text-sm  p-1'>refinary</h2>
          </div>
        </div>
