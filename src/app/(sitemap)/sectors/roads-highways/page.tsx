  ...
  return (
    <div className=''>
      <div className='flex flex-row mt-2 mb-2 ml-12'>
        ...
        <RxSlash color='gray' className='mt-1' />
        <p className='font-bold text-num-indigo'>Roads & Highways</p>
      </div>
      <div className='relative '>
        <Image
          src={`/sectors/RoadsHighways.jpg`}
          width={2046}
          height={768}
          alt='Roads & Highways'
      ...
      <div className='flex flex-row text-justify pr-8 ml-8'>
        ...
        <div className='flex flex-col w-3/5  mr-14'>
          <h2 className='text-3xl   font-bold  mb-4'>Road & Highways </h2>
          <hr className='border-b-2  border-num-orange' />
          <p className='md:text-2xl text-xs mt-4  flex '>
            As catalysts for economic growth and facilitators of connectivity,
            roads are indispensable for development. It not only augments job
            creation but also enhances community cohesion.
          </p>{' '}
          <p className='   md:text-lg text-xs mt-4  flex '>
            With increasing urbanization, expanding, investing and upgrading
            road infrastructure has never been more crucial.
          </p>{' '}
          <br />
